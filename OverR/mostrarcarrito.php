...
<br>
<h2 style="color: black;">Lista del carrito</h2>
<?php $total =0; ?>
<?php if(!empty($_SESSION['CARRITO'])) {  ?>
<table class="table table-light table-bordered">
    <tbody>
        <tr>
            <td width="40%"> <b>Descripcion</b></td>
          ...
          <tr>
            ...
            <form action="pagar.php" method="post">
             ...
             <div class="form-group">
              ...
              <button class="btn-lg" type="submit" name="btnAccion" value="proceder">Proceder a pagar</button>
            </form>
